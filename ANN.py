...
def main():
    ...
    parse = argparse.ArgumentParser(description='UNet-ANN')
    ...
    for epoch in range(epochs):
        mean_loss = train_one_epoch(net, optimizer, train_dataloader, device, epoch, num_classes, print_freq=10)
        confmat, dice = evaluate(net, val_dataloader, device, num_classes)
...
def train_one_epoch(model, optimizer, data_loader, device, epoch, num_classes, print_freq=10):
    model.train()
